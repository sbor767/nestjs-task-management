...
describe('TaskService', () => {
  ...
  describe('createTask', () => {
    it('calls createTask and returns task object', async () => {
      expect(taskRepository.createTask).not.toHaveBeenCalled();
      const mockCreateTaskDto = {
        title: 'Test title',
        description: 'Test desc',
      };
      taskRepository.createTask.mockResolvedValue({ id: 1, ...mockCreateTaskDto });
      ...
      expect(result).toEqual({ id: 1, ...mockCreateTaskDto });
    });  
